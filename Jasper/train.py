...
def main(args):
    ...
    torch.backends.cudnn.deterministic = args.det

    print_once("det: {}".format(torch.backends.cudnn.deterministic))
    print_once("bench: {}".format(torch.backends.cudnn.benchmark))
...
def parse_args():
    ...
    parser.add_argument("--det", action="store_true", default=False, help="enable deterministic ctc loss")
